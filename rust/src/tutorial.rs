pub mod tutorial {
    ...
    pub fn owernship(){
        ...
        pub fn printBookId(book: &Book){
                println!("{}", book.id);
            }
        pub fn printBookPages(book: &Book){
                println!("{}", book.pages);
            }
            printBookId(&book);
            printBookPages(&book);
    ...
    pub fn impl_keyword1(){
            ...
            // impl Temperature {
            // pub fn show_temp(temp: Temperature){
    ...
    pub fn impl_keyword() {
            ...
            impl ShippingBox {
            pub fn new(weight: f64, dimensions: Dimensions,  color: Color) -> Self {
                    Self {
                        dimensions,
                        weight,
                        color
    ...
    pub fn result_data_type(){
        ...
        pub fn print_choice(choice: &MenuChoice){
